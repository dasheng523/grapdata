(defproject grapdata "0.1.0-SNAPSHOT"
  ...
  :uberwar
  {:handler grapdata.handler/app
   :init grapdata.handler/init
   :destroy grapdata.handler/destroy
   :name "grapdata.war"}
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "grapdata.core/mount-components"}
                     :compiler
                     {:main "grapdata.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
